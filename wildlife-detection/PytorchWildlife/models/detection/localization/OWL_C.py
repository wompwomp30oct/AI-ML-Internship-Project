...
from .model_owl_c import OWLC_Architecture
...
class OWLC(BaseDetector):
    """
    OWL-C (Overhead Wildlife Locator - CNN) detector class. This class provides utility methods for
    ...
    def __init__(self, weights=None, device="cpu", version='general', url="https://zenodo.org/records/18165116/files/herdnet_loc_branch_wildme.pth?download=1", transform=None):
        ...
        """
        super(OWLC, self).__init__(weights=weights, device=device, url=url)
    ...
    def _load_model(self, weights=None, device="cpu", url=None):
        ...
        self.model = OWLC_Architecture(pretrained=False)
